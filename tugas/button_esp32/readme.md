...
```markdown
# BUTTON ESP32-S3 Experiment

##  Deskripsi = 
Program ini menguji Button menggunakan ESP32-S3 di Wokwi Simulator.  
Button dijalankan menggunakan FreeRTOS Task yang bisa diatur ke core 0 atau core 1.
...
|------------|-------------|------------|
| BTN1.1L        | 17         | Input digital Button|
| BTN1.2L        | GND         | Ground        |
...
Hasil Percobaan :
Core 0 : https://youtu.be/F5N-Br5lWSg
Core 1 : https://youtu.be/Uf-ZRa55xIA